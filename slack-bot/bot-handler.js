...
**If worker confirmed:** The manager knows who they want and they're already in the talent pool — go straight to output. Route is always "worksome". Say something like: "Perfect — I'm setting up the direct hire for [name] now." Then immediately output the JSON with known_worker: true, worker_found: true, route: "worksome", and the worker's details. Skip all routing questions and enrichment — the hire page in Worksome will collect everything else.
